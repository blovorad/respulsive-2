...
void initWindowAndRenderer(void)
{
	...
	fscanf(fichier, "%d", &localisation);

	if(fullscreen == SDL_FALSE)
	{
		screen = SDL_CreateWindow("REPULSIVE", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_SHOWN);
	}
	else
	{
		screen = SDL_CreateWindow("REPULSIVE", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_FULLSCREEN);
	}
